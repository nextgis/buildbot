...
repositories = [
    ...
    {'repo':'lib_proj', 'args':['-DWITH_SQLite3=ON', '-DWITH_SQLite3_EXTERNAL=ON', '-DPROJ_TESTS=ON', '-DGENERATE_PROJ_DB=ON', '-DWITH_GTest_EXTERNAL=ON'], 'requirements':[], 'skip':[], 'org':'nextgis-borsch', 'test_regex':[]},
