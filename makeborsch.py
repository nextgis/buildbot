...
repositories = [
    ...
    {'repo':'py_sip', 'args':['-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'py_markupsafe', 'args':['-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    {'repo':'py_subprocess32', 'args':['-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    {'repo':'py_kiwisolver', 'args':['-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'py_yaml', 'args':['-DWITH_YAML_EXTERNAL=ON', '-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'py_spatialite', 'args':['-DWITH_SQLite3_EXTERNAL=ON', '-DWITH_Spatialite_EXTERNAL=ON', '-DWITH_PROJ_EXTERNAL=ON', '-DWITH_GEOS_EXTERNAL=ON', '-DWITH_ICONV=ON', '-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]}, # TODO: FreeXL,
    {'repo':'py_matplotlib', 'args':['-DWITH_PNG_EXTERNAL=ON', '-DWITH_Freetype_EXTERNAL=ON', '-DWITH_AGG_EXTERNAL=ON', '-DWITH_QHULL_EXTERNAL=ON', '-DWITH_NUMPY_EXTERNAL=ON', '-DWITH_PYTHON3=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'lib_qwt', 'args':['-DWITH_Qt5_EXTERNAL=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'formbuilder', 'args':['-DBUILD_NEXTGIS_PACKAGE=ON', '-DWITH_GDAL_EXTERNAL=ON','-DWITH_ZLIB=ON', '-DWITH_Qt5_EXTERNAL=ON', '-DWITH_NGSTD_EXTERNAL=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis', 'test_regex':[], 'sentry_project': 'production-fb'},
    ...
    {'repo':'lib_oci', 'args':['-DWITH_Qt5_EXTERNAL=ON', '-DBUILD_QT5=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'lib_harfbuzz', 'args':['-DHB_HAVE_FREETYPE=ON', '-DWITH_Freetype_EXTERNAL=ON', '-DWITH_Freetype=ON', '-DHB_BUILD_SUBSET=OFF', '-DHB_BUILD_TESTS=OFF'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'lib_zip', 'args':['-DWITH_ZLIB=ON', '-DENABLE_GNUTLS=OFF', '-DENABLE_BZIP2=OFF', '-DENABLE_LZMA=OFF'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'py_lxml', 'args':['-DWITH_LIBXML2=ON', '-DWITH_LIBXML2_EXTERNAL=ON', '-DWITH_LIBXSLT_EXTERNAL=ON', '-DWITH_ZLIB=ON', '-DWITH_ICONV=ON', '-DWITH_PYTHON3=ON'], 'requirements':[''], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    {'repo':'lib_exiv', 'args':['-DWITH_ZLIB=ON', '-DWITH_EXPAT_EXTERNAL=ON', '-DWITH_ICONV=ON'], 'requirements':[''], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
    ...
    {'repo':'spatialite', 'args':['-DWITH_SPATIALITE_EXTERNAL=ON', '-DWITH_SQLite3_EXTERNAL=ON', '-DWITH_ICONV=ON', '-DWITH_EXPAT_EXTERNAL=ON', '-DWITH_LIBXML2_EXTERNAL=ON'], 'requirements':[], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
]
