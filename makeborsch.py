...
repositories = [
    ...
    {'repo':'py_sci', 'args':['-DWITH_Openblas_EXTERNAL=ON'], 'requirements':['numpy', 'pybind11', 'Tempita'], 'os':['win32','win64'], 'repo_root':'https://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
