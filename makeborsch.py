...
repositories = [
    ...
    {'repo':'py_lxml', 'args':['-DWITH_LIBXML2_EXTERNAL=ON', '-DWITH_LIBXML2_EXTERNAL=ON', '-DWITH_LIBXSLT_EXTERNAL=ON', '-DWITH_ZLIB_EXTERNAL=ON', '-DWITH_ICONV_EXTERNAL=ON'], 'requirements':[''], 'os':['win32','win64','mac'], 'repo_root':'git://github.com', 'org':'nextgis-borsch', 'test_regex':[]},
]
