...
repositories = [
    {'repo':'lib_geos', 'deb':'geos', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_proj', 'deb':'proj', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_geotiff', 'deb':'libgeotiff', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_opencad', 'deb':'opencad', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_oci', 'deb':'oci', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_gdal', 'deb':'gdal', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'lib_spatialite', 'deb':'spatialite', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    {'repo':'mapserver', 'deb':'mapserver', 'repo_root':'git://github.com', 'org': 'nextgis-borsch', 'os':['bionic', 'bullseye', 'focal', 'buster', ], 'repo_id':11},
    ...
    {'repo':'terratile', 'deb':'python-terratile', 'repo_root':'git://github.com', 'org': 'nextgis', 'os':['bionic', 'bullseye', 'focal', 'buster'], 'repo_id':11, 'branch': 'gdal3'},
