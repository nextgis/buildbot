...
repositories = [
    {'repo':'lib_geos', 'deb':'geos', 'subdir': '', 'org':'nextgis-borsch', 'os': ['bionic', 'stretch'], 'repo_id': 11},
    # 'xenial', 'buster', {'repo':'lib_gdal', 'version':'2.4.0', 'deb':'gdal', 'subdir': 'master', 'org':'nextgis-borsch', 'url': '', 'ubuntu_distributions': ['trusty', 'xenial', 'bionic']},
