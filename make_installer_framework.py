...
factory_win.addStep(steps.Git(repourl='git://github.com/nextgis-borsch/lib_openssl.git',
                                mode='full',
                                submodules=False,
                                workdir=code_dir))
...
factory_mac.addStep(steps.Git(repourl='git://github.com/nextgis-borsch/lib_openssl.git',
                                mode='full',
                                submodules=False,
                                workdir=code_dir))
