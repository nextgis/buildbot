...
c['schedulers'].append(schedulers.ForceScheduler(
                            ...
                            builderNames=[project_name + "_deb", project_name + "_debdev"])) # TODO: project_name + "_win",
