"""
This module defines the Buildbot configuration for automating the creation of a RepkaSDK release.
...
- Uploading the repository and creating a release in RepkaSDK.
...
from nextgis_buildbot.steps.repka_sdk_steps import RepkaEnsureSdk, RepkaCreateRelease

BUILDER_NAME = "repka_sdk_builder"
...
SIDELOAD_REPO_NAME = "repka-sdk-repo"
