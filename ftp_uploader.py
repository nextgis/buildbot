...
if __name__ == "__main__":
    ...
    parser.add_argument('--ftp_user', dest='ftp_user', required=True, help='ftp login:password')
    parser.add_argument('--ftp', dest='ftp', required=True, help='ftp url')
    parser.add_argument('--build_path', dest='build', required=True, help='release file to upload')
